...
class IMUPublisher : public rclcpp::Node
{
	public:
		...
		IMUPublisher() : Node("IMU_publisher")	
		{
			...
			this->get_parameter("yaw_topic",yaw_topic);
			...
			RCLCPP_INFO(this->get_logger(), "yaw_topic: %s\r\n", yaw_topic.c_str());
			
			imu_data.header.frame_id = frame_id;
			imu_pub = this->create_publisher<sensor_msgs::msg::Imu>(imu_topic, 20);
			yaw_pub = this->create_publisher<std_msgs::msg::Float32>(yaw_topic, 20);
	...
	private: 
		...
		std_msgs::msg::Float32 yaw_data = std_msgs::msg::Float32();
